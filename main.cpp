...
int main()
{
    ...
    //Question is set, 4 answer choices, the correct char answer, 6 marks per question.
    q1.setValues("1. Which of the following is discrete variable of the ratio measurement level?\n",
        ...
        "The years in which there was major flooding in KZN",
        'a',
        6);

    q2.setValues("2.Complete the following sentence \n In stratified sampling... \n",
        ...
        "the population is divided into groups according to some characteristic then simplerandom sampling is performed in each group",
        "every kth member of the population is selected to be in the sample, where k=n*N",
        'c',
        6);
    ...
    //If the user scores 75 or above  75, user passes the quiz.
